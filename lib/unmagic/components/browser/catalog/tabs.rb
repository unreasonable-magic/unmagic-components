...
Unmagic::Components::Browser::Catalog.component :tabs,
  ...
  examples: [
    ...
    { key: :bar, title: "The bar style, with icons", layout: :full,
      description: "style: :bar is pill tabs with no track, for a bar across a card or a page. icon: leads " \
                   "each label. On a narrow screen the row scrolls sideways and the chosen tab is kept in view." }
  ]
